  ...
  render () {
    ...
    return (
      <div className='container'>
        ...
        <Row>
          <Icon left>access_alarm</Icon><DateTime className="col s5" defaultValue={moment({ hour:10})} timeConstraints={ {minutes: { step: 15 }}} onChange={this.getStartTime} name="start-date" />
          <Icon left>access_alarm</Icon><DateTime className="col s5" defaultValue={moment({ hour:11})} timeConstraints={ {minutes: { step: 15 }}} onChange={this.getEndTime} name="end-date" />
        </Row>
        <Row>
